                ...
                <div className="col-md-12">
                  ...
                  >
                    <div className="col-sm-11">
                      ...
                      >
                        <InputLabel
                          style={{
                            color: this.state.shareholderAgreement_Error !== true ? "#976340" : "red"
                          }}
                        >
                  ...
                  >
                    <FormLabel
                      style={{
                        color:
                          this.state.accreditedInvestor_Error !== true ? "#976340" : "red",
              ...
              <div className="row">
                ...
                >
                  <p className={`${styles.electionsGeneralText} text-justify`}>
                    Due to the secure nature of the above information, please
