...
export class AdminAccountInformation extends React.Component<any, any> {
  ...
  public constructor(props: any, state: any) {
    ...
    //this.updateStockandOptions = this.updateStockandOptions.bind(this);
      ...
      newWeb.lists
        ...
        .then(d => {
          if (d.length > 0) {
            this.setState({
              stockandOptions: d[0],
              unrestrictedShares: d[0].unrestrictedShares,
              restrictedShares: d[0].restrictedShares,
              vestedOptions: d[0].vestedOptions,
              unVestedOptions: d[0].unvestedOptions
            });
          }
...

{
  /* <MenuItem value="INDIV">
                                          ...
                                          <MenuItem value="TEO">TEO</MenuItem>
                                          <MenuItem value="ESTATE">
                                            ESTATE
                                          </MenuItem> */
}
